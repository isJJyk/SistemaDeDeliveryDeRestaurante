...
public class Login {
    ...
    private final String[] emails = {"0001193455@senaimgaluno.com.br", "joao"};
    private final String[] senhas = {"Hd87555", "bubu"};
    ...
    //Dar seguimento na seleção e calculo total do pedido-JJ
